            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-5">
                        <img src="/goingon1.jpg" alt="event1" className='img-fluid rounded-5 mb-3' />
                    ...
                    <div className="col-md-5">
                        <div>
                            ...
                            <div className="d-flex justify-content-between gap-3">
                                <div className="col-md-4">
                                    <img src="/goingon2.jpg" alt="event1" className='img-fluid rounded-5 mb-3 w-md-25' />
                                </div>
                        ...
                        <div>
                            ...
                            <div className="d-flex justify-content-between gap-3">
                                <div className="col-md-4">
                                    <img src="/goingon3.jpg" alt="event1" className='img-fluid rounded-5 mb-3 w-md-25' />
                                </div>
                                <div className="col-md-8">
                        ...
                        <div>
                            ...
                            <div className="d-flex justify-content-between gap-3">
                                <div className="col-md-4 col-sm-12">
                                    <img src="/goingon4.jpg" alt="event1" className='img-fluid rounded-5 mb-3 w-md-25' />
                                </div>
